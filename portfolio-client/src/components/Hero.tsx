      ...
      <div className="px-2 md:px-0 sm:container grid items-center justify-center gap-6 lg:grid-cols-2 lg:gap-10">
        <div className="space-y-6 order-2 lg:order-1">
          ...
          <div className="flex gap-5">
            <Link
              href="/projects"
              className="inline-flex h-10 items-center justify-center rounded-md bg-primary dark:bg-[#ff3366] px-10 text-sm font-medium text-primary-foreground dark:text-white shadow transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 uppercase hover:bg-transparent dark:hover:bg-transparent hover:text-primary dark:hover:text-[#ff3366] border hover:border-primary dark:hover:border-[#ff3366]"
              prefetch={false}
            >
              Projects
            </Link>
